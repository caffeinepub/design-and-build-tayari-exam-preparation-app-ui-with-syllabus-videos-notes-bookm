    ...
    <Tabs defaultValue="topics" className="w-full">
        ...
        <Card className="p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">
              Second Paper Topics ({topics?.length || 0})
            </h2>
            <Button
      ...
      <TabsContent value="videos" className="space-y-6">
        <Card className="p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">
              Second Paper Videos ({videos?.length || 0})
            </h2>
            <Button
            ...
            <form onSubmit={handleSubmitVideo} className="mb-6 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Enter topic name (e.g., Karyalaya Byabasthapan, Sambandhan, Maths)"
                  required
                />
              </div>
              <div>
      ...
      <TabsContent value="notes" className="space-y-6">
        <Card className="p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">
              Second Paper Notes ({notes?.length || 0})
            </h2>
            <Button
