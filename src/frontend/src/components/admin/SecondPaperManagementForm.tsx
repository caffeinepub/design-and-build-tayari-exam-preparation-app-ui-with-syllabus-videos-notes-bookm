...
import { useSecondPaperManagement } from '@/hooks/useSecondPaperManagement';
import { toast } from 'sonner';

export default function SecondPaperManagementForm() {
  ...
  const {
    ...
    isDeletingVideo,
    isDeletingNote,
  } = useSecondPaperManagement();

  const handleAddTopic = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await addTopic({ title: topicTitle, description: topicDescription });
      toast.success('Second Paper topic added successfully!');
      setTopicTitle('');
      setTopicDescription('');
    } catch (error) {
  ...
  const handleAddVideo = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Second Paper video added successfully!');
      setVideoTitle('');
      setVideoDescription('');
      setYoutubeUrl('');
    } catch (error) {
  ...
  const handleAddNote = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Second Paper note added successfully!');
      setNoteTitle('');
      setNoteDescription('');
      setDriveUrl('');
    } catch (error) {
