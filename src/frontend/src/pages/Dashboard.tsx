        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Avatar className="w-10 h-10 border-2 border-emerald-500">
              <AvatarImage
                src="/assets/generated/psc-profile.dim_512x512.png"
                alt="PSC तयारी"
              />
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-emerald-50">
                    सबै पेपरहरूको लागि पूर्ण तयारी सामग्री
                  </p>
                </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-3 gap-4">
            {firstPaperSubjects.map((subject) => (
              ...
              >
                <div
                  className={`h-full p-6 bg-gradient-to-br ${subject.color} text-white flex flex-col items-center justify-center space-y-3`}
                >
